...
dataset_path = "./esc-50" # the dataset path
desed_folder = "./desed" # the desed file
...
# resume_checkpoint = "./ckpt/htsat_audioset_pretrain.ckpt"
resume_checkpoint = None

# "/home/Research/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
#resume_checkpoint = "./model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
...
wa_folder = "./version_0/checkpoints/"
# weight average output filename
wa_model_path = "HTSAT_AudioSet_Saved_x.ckpt"

esm_model_pathes = [
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt",
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_2.ckpt",
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_3.ckpt",
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_4.ckpt",
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_5.ckpt",
    "./model_backup/AudioSet/HTSAT_AudioSet_Saved_6.ckpt"
]
